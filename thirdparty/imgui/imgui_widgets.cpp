...
void ImGui::ToggleButton(const char* str_id, bool* v)
{
    ...
    if (ImGui::IsItemHovered())
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(0.17f, 0.16f, 0.22f, 1.00f), ImVec4(0.64f, 0.83f, 0.34f, 1.0f), t));
    else
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(0.10f, 0.09f, 0.12f, 1.00f), ImVec4(0.56f, 0.83f, 0.26f, 1.0f), t));
